          ...
          <div className="space-y-4 md:hidden">
            ...
            {!loading &&
              paginatedRows.map((item) => {
                ...
                return (
                  <article key={item._id} className="rounded-[24px] border border-[#edf3e6] bg-white p-4 shadow-sm">
                    <div className="flex items-start justify-between gap-3">
                      <div className="min-w-0">
                        <p className="text-sm font-semibold text-[#2d3d33]">
                          {item.userId?.nombre || "Usuario eliminado"}
                        </p>
                        <p className="mt-1 text-sm text-slate-500">{item.userId?.email || "Sin email"}</p>
                      </div>
                      <span
                    ...
                    <div className="mt-3 space-y-1 text-sm text-slate-600">
                      ...
                      <p className="font-medium text-[#35561a]">+{item.points} puntos</p>
                    ...
                    <div className="mt-4 flex items-center gap-2">
                      ...
                      <RowActionsMenu
                        items={[
                          pending
                            ? {
                                label: busyId === item._id ? "Procesando..." : "Aprobar",
                                icon: FiCheckCircle,
