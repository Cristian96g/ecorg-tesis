...
const clip = `polygon(74.1% 44.1%, 100% 61.6%, 97.5% 26.9%, 85.5% 0.1%, 80.7% 2%,
      ...
      >
        <div
          ...
          className="relative left-[calc(50%-11rem)] aspect-[1155/678] w-[36rem] -translate-x-1/2 rotate-30
                     bg-gradient-to-tr from-white to-white opacity-10
      ...
      >
        <div
          ...
          className="relative left-[calc(50%+3rem)] aspect-[1155/678] w-[36rem] -translate-x-1/2
                     bg-gradient-to-tr from-white to-white opacity-20
